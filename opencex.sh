...
mkdir /app/opencex -p
cd /app/opencex || exit
git clone https://github.com/masterlexa/OpenCEX-backend.git ./backend
git clone https://github.com/masterlexa/OpenCEX-frontend.git ./frontend
git clone https://github.com/masterlexa/OpenCEX-static.git ./nuxt
git clone https://github.com/masterlexa/OpenCEX-JS-admin.git ./admin
